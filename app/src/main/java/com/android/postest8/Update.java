...
public class Update extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = db.rawQuery("SELECT * FROM tb_brg WHERE barang = '" + getIntent().getStringExtra("barang") + "'",null);
        cursor.moveToFirst();
	    ...
	    ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                 ...
                 db.execSQL("update tb_brg set barang='"+
                         text2.getText().toString() +"', harga='" +
                         text3.getText().toString()+"', stok='"+
                         text4.getText().toString() +"', suplier='" +
